...
class AppConstants {
  ...
  /// Maximum photos to load initially
  static const int maxInitialPhotos = 100;
  ...
  static const String categoryResumeDesc = 'Start where your last dump session ended';
  ...
  static const String emptyDumpBoxMessage = 'Photos you swipe left will appear here for review before deletion.';
