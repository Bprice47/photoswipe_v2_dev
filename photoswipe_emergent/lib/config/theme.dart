...
class AppTheme {
  ...
  static const Color accentSecondary = Color(0xFFE91E63);     // Pink/Magenta (DumpBox badge)
  ...
  static const Color selectedBorder = Color(0xFF4CAF50);      // Green selection border
  ...
  static const Color checkmarkBg = Color(0xFF4CAF50);         // Green checkmark background
